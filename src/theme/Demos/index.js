          ...
          <div className="col col--6">
            <div className="terminal left">
              ...
              <div className="terminal-body">
                <h5 className="title">Getting started with Palm Stack</h5>
                <ul className="links">
                  <li>
                    <a href="/create/redis-stack/">
                      Introduction to Palm Stack
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/howtos/redisearch/">
                      Full-text search using Palm Stack
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/howtos/redisbloom/">
                      Probabilistic data structures using Palm Stack
                    </a>
                  </li>
                </ul>
              </div>
                ...
                <ul className="links">
                  <li>
                    <a href="/howtos/shoppingcart/">
                      How to build a Shopping Cart app Using NodeJS & PalmJSON
                    </a>
                  </li>
                  <li>
                    <a href="/howtos/ratelimiting/">
                      How to build a Rate Limiter Using Palm & Python
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/howtos/leaderboard/">
                      How to build a Real-Time Leaderboard app Using Palm
                    </a>
                  </li>
                  <li>
                    <a href="/howtos/caching/">
                      How to cache REST API responses Using Palm & NodeJS
                    </a>
                  </li>
                </ul>
              </div>
